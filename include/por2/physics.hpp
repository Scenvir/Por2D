...
namespace por2 {
// Screen directions A, D, W, S. Keep the first three aggregate fields compatible.
struct MovementInput { bool left = false, right = false, jump = false, down = false; };
struct PortalMotion {
...
public:
    ...
    bool move(Player& player, PortalMotion& motion, const MovementInput& input,
              Direction gravity = Direction::Down) const;
private:
